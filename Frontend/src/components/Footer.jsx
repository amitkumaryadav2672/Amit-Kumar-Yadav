    ...
    <footer className="footer glass-panel">
      <div className="footer-content">
        ...
        <div className="footer-middle">
          ...
          <a href="https://mail.google.com/mail/?view=cm&fs=1&to=yadavamit847412@gmail.com&su=Let's discuss an opportunity&body=Let's discuss an opportunity" target="_blank" rel="noreferrer" aria-label="Email">
            <Mail size={20} />
          </a>
        </div>
